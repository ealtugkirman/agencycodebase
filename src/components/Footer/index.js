...
const Footer = () => {
  return (
    <footer className="bg-first text-white lg:grid lg:grid-cols-5 mt-24">
      ...
      <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            ...
            <ul className="mt-8 flex gap-6">
              <li>
                <a
                  href="https://www.instagram.com/digitalvoyage.agency/"
                  rel="noreferrer"
                  target="_blank"
        ...
        <div className="mt-12 border-t border-white pt-12 ">
