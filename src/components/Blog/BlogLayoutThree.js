...
const BlogLayoutThree = ({ blog }) => {
  return (
    <div className="group flex flex-col items-center text-dark">
      <Link href={blog.url} className="h-full roverflow-hidden">
        <Image
         ...
         className=" aspect-[4/3] object-cover object-center  group-hover:scale-105 transition-all ease duration-300 "
